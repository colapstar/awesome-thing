  ...
  <div>
    <div class="d-flex flex-column justify-content-center bg-black bg-opacity-50 mx-auto mt-5 w-40 rounded-2">
      ...
      <form class="w-75 mx-auto mt-5" @submit.prevent="execute_action()">
        ...
        <div v-if="action === 'register'" class="form-group row mt-3">
          <label class="col-lg-2 col-form-label col-form-label-lg">E-Mail</label>
          <div class="col-lg-10">
            <input v-model="user.email" type="text" class="form-control form-control-lg" placeholder="E-Mail">
          </div>
        </div>
        <div class="form-group row mt-3">
